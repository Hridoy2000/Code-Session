...
<body>
    <div class="container fluid mt-3"> 
        <div class="d-flex justify-content-center bg-success mb-5">
    <?php echo "<h1>Welcome ". $_SESSION['username'] . "</h1>"; ?>
    </div>
    
    <table class="table table-bordered table-dark" >
        <tr> 
            <th colspan="4"><h2 class="text-info text-center text-warning">Users Information</h2></th>
        </tr>
    ...
    <br>
    <button type="button" class="btn btn-warning "><a href="logout.php"><p class="text-danger mt-2 ">LOGOUT</p></a> </button>
    </div>
